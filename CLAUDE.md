...
This project is indexed by GitNexus as **boss-agent** (1718 symbols, 2841 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
