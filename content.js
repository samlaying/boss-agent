...
function initWrapper() {
    ...
    panel.innerHTML = `
      ...
      <div class="panel-body" style="padding:15px; flex:1; overflow-y:auto; display:flex; flex-direction:column; gap:12px; background:var(--bg-primary);">
          ...
          <!-- Tab 导航 -->
          <div class="tab-navigation" style="display:flex; background:#fff; border-radius:var(--radius-md) var(--radius-md) 0 0; border:1px solid var(--border-light); overflow:hidden;">
              <button class="tab-btn active" data-tab="report" style="flex:1; padding:10px; border:none; background:rgba(0,190,189,0.05); color:var(--primary-color); font-weight:bold; font-size:12px; border-bottom:2px solid var(--primary-color);">📊 深度报告</button>
              <button class="tab-btn" style="flex:1; padding:10px; border:none; background:#fff; color:var(--text-secondary); font-size:12px;">💬 智能追问</button>
          </div>

          <!-- 报告内容区 -->
          <div id="report-tab" style="display:block;">
              <div id="report-content" style="display:none; background:#fff; padding:15px; border-radius:0 0 var(--radius-md) var(--radius-md); border:1px solid var(--border-light); border-top:none; box-shadow:var(--shadow-sm);">
                  ...
                  <div id="report-score-section" style="background:#fff; border:1px solid var(--border-light); border-radius:var(--radius-md); padding:15px; margin-bottom:15px; box-shadow:var(--shadow-sm); position:relative; overflow:hidden;">
                      ...
                      <!-- 3-Column Layout: Sync Engine | Conflict Audit | Truth Scanner -->
                      <div style="display:flex; align-items:stretch; gap:8px;">
                          
                          <!-- 1. Sync Engine (Left) -->
                          <div style="flex:0 0 75px; display:flex; flex-direction:column; align-items:center; justify-content:center; border-right:1px solid #f0f0f0; padding-right:8px;">
                               <div style="position:relative; width:50px; height:50px; display:flex; align-items:center; justify-content:center;">
                                   <!-- Pulse Effect Circle -->
                                   <div id="sync-pulse" style="position:absolute; width:100%; height:100%; border-radius:50%; background:rgba(0,190,189,0.1); animation:pulse 2s infinite;"></div>
                                   <div id="res-score" style="font-size:24px; font-weight:900; color:var(--text-primary); line-height:1; z-index:2;">--</div>
                               </div>
                               <div style="font-size:9px; color:#999; margin-top:2px; text-transform:uppercase; font-weight:700;">Sync Rate</div>
                               <div id="match-status-badge" style="font-size:9px; background:#eceff1; color:#546e7a; padding:1px 6px; border-radius:8px; margin-top:4px; font-weight:bold;">
                                   待分析
                               </div>
                          </div>

                          <!-- 2. Conflict Audit (Center) -->
                          <div id="audit-conflict-wrapper" style="flex:1; padding:0 15px; display:flex; flex-direction:column; justify-content:center;">
                               <div id="audit-conflict-list" style="width:100%;">
                                   <div style="font-size:10px; color:#90a4ae; font-weight:bold; margin-bottom:8px; text-transform:uppercase;">🛠️ 冲突审计</div>
                                   <div style="font-size:11px; color:#b0bec5; font-style:italic;">正在扫描...</div>
                               </div>
                          </div>

                          <!-- 3. Truth Scanner (Right) -->
                          <div style="flex: 0 0 140px; padding: 5px 0 5px 10px; border-left: 1px dashed #eee;">
                               <div id="truth-audit-box" style="height:100%;">
                                   <div style="font-size:10px; color:#b0bec5;">Waiting...</div>
                               </div>
                          </div>
                      </div>
                  </div>
