...
This project is indexed by GitNexus as **boss-agent** (1598 symbols, 2658 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
